...
export const AddressForm: React.FC<AddressFormProps> = ({
    ...
    const buildFullAddress = (
        ...
        const parts = [street, suburb, state, postcode].filter(
            (part) => part && part.trim()
        )
        return parts.join(", ")
    }
        ...
        >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                    ...
                    <input
                        ...
                        className="p-3 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                ...
                <div className="md:col-span-2">
                    ...
                    <div className="mt-1 p-3 bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md">
                        <p className="text-sm text-gray-600 dark:text-gray-300">
                            {currentFullAddress ||
                                "Address will be built from the fields below"}
                        </p>
                    </div>
                </div>
            ...
            <div className="flex justify-end space-x-3">
                ...
                <button
                    ...
                    className="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-stone-950 hover:bg-stone-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-stone-500 disabled:opacity-50 disabled:cursor-not-allowed"
                >
