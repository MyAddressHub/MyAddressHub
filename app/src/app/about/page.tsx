            ...
            <div className="max-w-6xl mx-auto px-4 py-12">
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-600 dark:text-gray-300">
                        Revolutionary Address Management with Blockchain
                        Integration
                    </p>
                </div>
                ...
                <div className="prose prose-lg max-w-none dark:prose-invert">
                    ...
                    <section className="mb-12">
                        <h2 className="text-2xl font-bold text-stone-950 dark:text-white mb-6">
                            🚀 Current Features
                        </h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border-l-4 border-blue-500">
                                ...
                                <p className="text-gray-600 dark:text-gray-300 text-sm">
                                    All address data is encrypted using Fernet
                                    symmetric encryption with PBKDF2 key
                                    derivation. Sensitive information is never
                            ...
                            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border-l-4 border-green-500">
                                ...
                                <p className="text-gray-600 dark:text-gray-300 text-sm">
                                    Address data is automatically synced to
                                    blockchain using Hardhat testnet. Smart
                                    contracts ensure data integrity and provide
                            ...
                            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border-l-4 border-purple-500">
                                ...
                                <p className="text-gray-600 dark:text-gray-300 text-sm">
                                    Support for both individual and organization
                            ...
                            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border-l-4 border-orange-500">
                                ...
                                <p className="text-gray-600 dark:text-gray-300 text-sm">
                                    Celery-based background tasks automatically
                                    sync new addresses to blockchain every 5
                                    minutes. Batch processing ensures efficient
                            ...
                            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border-l-4 border-red-500">
                                ...
                                <p className="text-gray-600 dark:text-gray-300 text-sm">
                                    Track sync status, blockchain transactions,
                                    and last sync timestamps. Comprehensive
                            ...
                            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border-l-4 border-indigo-500">
                                ...
                                <p className="text-gray-600 dark:text-gray-300 text-sm">
                                    Built with Next.js 14, React, and Tailwind
                                    CSS. Responsive design with dark mode
                                    support and intuitive user interface.
                                </p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="mb-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                                <h3 className="text-lg font-semibold text-stone-950 dark:text-white mb-4">
                                    Backend Services
                                </h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg">
                                ...
                                <ul className="text-blue-700 dark:text-blue-300 space-y-2 text-sm">
                                    <li>
                                        • Create and manage personal addresses
                                    </li>
                                    <li>
                                        • View address history and sync status
                                    </li>
                                    <li>
                                        • Access to encrypted address storage
                                    </li>
                                    <li>
                        ...
                        <div className="space-y-6">
                            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                                ...
                                <p className="text-gray-600 dark:text-gray-300 mb-3">
                                    All sensitive address data is encrypted
                                    using industry-standard Fernet symmetric
                                    encryption:
                                </p>
                                <ul className="text-gray-600 dark:text-gray-300 space-y-1 text-sm ml-4">
                                    <li>
                                        • PBKDF2 key derivation with 100,000
                                        iterations
                                    </li>
                            ...
                            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                                ...
                                <p className="text-gray-600 dark:text-gray-300 mb-3">
                                    Smart contract-based address storage with
                                    automatic synchronization:
                                </p>
                                <ul className="text-gray-600 dark:text-gray-300 space-y-1 text-sm ml-4">
                                    <li>
                                        • Solidity smart contracts for data
                                        storage
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        • Automatic batch synchronization every
                                        5 minutes
                                    </li>
                                    <li>
                            ...
                            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                                ...
                                <ul className="text-gray-600 dark:text-gray-300 space-y-1 text-sm ml-4">
                                    <li>
                                        • Celery Beat scheduler for periodic
                                        tasks
                                    </li>
                    ...
                    <section className="mb-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm">
                                <h3 className="font-semibold text-stone-950 dark:text-white mb-2">
                                    Backend
                                </h3>
                            ...
                            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                                ...
                                <div className="space-y-2 text-sm">
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <span className="text-purple-600 dark:text-purple-400">
                                            /api/auth/organization/users/:id/role/
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                                ...
                                <p className="text-sm text-gray-600 dark:text-gray-300 mb-2">
                                    Project Lead / Security Architect
                                </p>
                                <p className="text-gray-600 dark:text-gray-300 text-sm">
                                    Defines system architecture, implements
                                    blockchain integration, and oversees
                            ...
                            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                                ...
                                <p className="text-gray-600 dark:text-gray-300 text-sm">
                                    Maintains project schedule, defines test
                                    plans, and manages quality assurance
                                    processes.
                                </p>
                            </div>
                            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                                ...
                                <p className="text-gray-600 dark:text-gray-300 text-sm">
                                    Implements React components, designs user
                                    interfaces, and ensures responsive design.
                                </p>
                            </div>
                            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                                <h3 className="font-semibold text-stone-950 dark:text-white mb-2">
                                ...
                                <p className="text-gray-600 dark:text-gray-300 text-sm">
                                    Builds Django APIs, implements database
                                    models, and integrates with external
                                    services.
                                </p>
                            </div>
                            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                                <h3 className="font-semibold text-stone-950 dark:text-white mb-2">
                                    Shahriar Morshed Shanto
                                </h3>
                                <p className="text-sm text-gray-600 dark:text-gray-300 mb-2">
                                    Frontend Developer / UX
                                </p>
                                <p className="text-gray-600 dark:text-gray-300 text-sm">
                                    Designs user flows, conducts usability
                                    testing, and refines components for
                                    accessibility.
                                </p>
                            </div>
                            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                                ...
                                <p className="text-gray-600 dark:text-gray-300 text-sm">
                                    Drafts technical documentation, produces
                                    user guides, and assists with quality
                                    assurance.
                                </p>
                            </div>
                        </div>
                    ...
                    <section className="mb-12">
                        <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg p-8 text-white text-center">
                            ...
                            <p className="text-lg mb-6">
                                Experience the future of address management with
                                blockchain integration and enterprise-grade
                                security.
                            </p>
