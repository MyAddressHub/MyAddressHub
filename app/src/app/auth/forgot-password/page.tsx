...
export default function ForgotPasswordPage() {
    ...
    if (success) {
        return (
            <div className="flex min-h-[calc(100vh-200px)] items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-stone-950">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    <div>
                        ...
                        <input
                            ...
                            className="px-3 relative block w-full rounded-md border-0 py-1.5 text-stone-950 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 dark:bg-gray-800 dark:text-white dark:ring-gray-700 dark:placeholder:text-gray-500 sm:text-sm sm:leading-6"
