                    ...
                    <div className="space-y-4 rounded-md shadow-sm">
                        <div>
                            ...
                            <input
                                ...
                                className="mt-1 block w-full rounded-md border-0 py-1.5 text-stone-950 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 dark:bg-gray-800 dark:text-white dark:ring-gray-700 dark:placeholder:text-gray-500 sm:text-sm sm:leading-6"
                                disabled={isLoading}
                            />
                            {errors.username && (
