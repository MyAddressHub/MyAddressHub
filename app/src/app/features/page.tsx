      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300">
            Discover the powerful features that make MyAddressHub the ultimate solution for secure, 
            compliant, and efficient address management.
          </p>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              RESTful API gateway that routes UUID resolution and update requests to dedicated microservices, 
              each responsible for validation, encryption, policy enforcement, or auditing.
            </p>
          </div>
        </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white">Django REST Framework</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                      Rapid API development with built-in authentication and serialization
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white">PostgreSQL 15</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                      Robust relational store for normalized address records
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white">Redis Caching</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                      In-memory caching and pub/sub for low-latency inter-service messaging
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white">Celery Task Queue</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                      Scalable background jobs for notifications and blockchain transactions
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white">Charm-Crypto (IBE)</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                      Implements bilinear-pairing IBE for secure key distribution
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white">PyNaCl (Double Ratchet)</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                      Provides forward secrecy in transit for dynamic data
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white">HSM/KMS Integration</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                      Secure storage and automated rotation of cryptographic keys
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white">Hyperledger Fabric</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                      Permissioned blockchain for tamper-evident audit trails
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-12 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <div className="text-center">
                ...
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Anomaly Detection</h4>
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  AI-driven monitoring flags suspicious access patterns and unauthorized attempts
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  Streaming analytics patterns and online-learning frameworks for live monitoring
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  Netdata, ELK stack, and Sentry for comprehensive observability
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 rounded-lg p-6">
              ...
              <p className="text-red-700 dark:text-red-300 text-sm">
                Automated address normalization and versioning remove manual reconciliation tasks, 
                leading to faster go-live cycles and reduced data-quality remediation.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-900/20 dark:to-indigo-800/20 rounded-lg p-6">
              ...
              <p className="text-indigo-700 dark:text-indigo-300 text-sm">
                AI-driven monitoring identifies anomalous access patterns—such as sudden spikes in resolution 
                requests—enabling security teams to respond before breaches occur.
              </p>
            </div>
          </div>
        </div>
